...
import { getSushiSyncPresenterTypeHelper } from "../models/PresenterModel";
import { getSushiSyncClientTypeHelper } from "../models/ClientModel";
...
// Main Game Page
// -------------------------------------------------------------------
export default class SushiSyncGameComponent extends ClusterfunGameComponent {
  // -------------------------------------------------------------------
  // ctor
  // -------------------------------------------------------------------
