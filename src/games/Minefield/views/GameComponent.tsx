...
import { getMinefieldPresenterTypeHelper } from "../models/PresenterModel";
import { getMinefieldClientTypeHelper } from "../models/ClientModel";
...
// Main Game Page
// -------------------------------------------------------------------
export default class MinefieldGameComponent extends ClusterfunGameComponent {
  // -------------------------------------------------------------------
  // ctor
  // -------------------------------------------------------------------
