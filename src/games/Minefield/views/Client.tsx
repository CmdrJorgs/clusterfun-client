...
class GameScreen extends React.Component<{ appModel?: MinefieldClientModel }> {
  ...
  animateFrame = (elapsed_ms: number) => {
    ...
    if (appModel?.gameState !== MinefieldClientState.Playing) return;
      ...
      <div>
        ...
        <div>
          ...
          <button
            ...
            onClick={() => this.props.appModel!.doColorChange()}
          >
            Change Colors
          </button>
          <button className={styles.clientButton} onClick={() => this.props.appModel!.doMessage()}>
            Say Something
          </button>
        </div>
      </div>
...
export default class Client extends React.Component<{
  ...
  private renderSubScreen() {
    ...
    switch (appModel!.gameState) {
      ...
      case MinefieldClientState.Playing:
        this.alertUser();
        return <GameScreen />;
      case MinefieldClientState.EndOfRound:
        this.alertUser();
